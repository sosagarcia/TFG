...
app.secret_key = b'}\xbe$ClA;\x87\xca,\x8d<\x8c\xbf\xf9\xed\x94G8K6\x0cL5'
...
def add_event():
    if request.method == 'POST':
        ...
        # Comprobar si start o end esta entre el start o el end de algun otro
        # evento (comprobación explusiva del modo Auto.)
